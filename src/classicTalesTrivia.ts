...
export const WIZARD_OF_OZ_TRIVIA: MCTriviaQuestion[] = [
  {
    "id": 1,
    "question": "What is Dorothy's surname?",
    "options": [
      "Gale",
      "Davies",
      "Drew",
    ...
    "answer": "Gale",
    "evidence": "Dorothy's surname is Gale."
  },
  {
    "id": 2,
    "question": "What is the good witch called?",
    "options": [
      "Belinda",
      "Grunhilda",
      "Glinda",
  ...
  {
    "id": 4,
    "question": "What breed of dog was Toto?",
    "options": [
      "Yorkshire Terrier",
      "Fox Terrier",
      "Cairn Terrier",
    ...
    "evidence": "Toto was a Cairn Terrier."
  },
  {
    "id": 5,
    "question": "Besides the Yellow Brick Road, what other coloured road runs through Munchkinland?",
    "options": [
      "Green",
      "Purple",
      "Red",
    ...
    "answer": "Red",
    "evidence": "Besides the Yellow Brick Road, a Red road runs through Munchkinland."
  },
  {
    "id": 6,
    "question": "Which of Dorothy's 3 companions does she meet first?",
    "options": [
      "Lion",
      "Scarecrow",
      "Tin Man",
    ...
    "answer": "Scarecrow",
    "evidence": "Dorothy meets the Scarecrow first."
  },
  {
    "id": 7,
    "question": "What was the name of the Munchkin Guild that gave Dorothy a musical welcome to the land of Oz?",
    "options": [
      "The Lollipop Guild",
      "The Marshmallow Guild",
      "The Candy Man Guild",
      "The Liquorice Guild"
    ],
    "answer": "The Lollipop Guild",
    "evidence": "The Munchkin Guild that gave Dorothy a musical welcome to the land of Oz was The Lollipop Guild."
  },
  {
    "id": 8,
  ...
  {
    "id": 9,
    "question": "The Good Witch is the Witch of the...?",
    "options": [
      "East",
      "West",
      "North",
    ...
    "answer": "North",
    "evidence": "The Good Witch is the Witch of the North."
  },
  {
    "id": 10,
    "question": "What kind of flowers put Dorothy and her friends to sleep?",
    "options": [
      "Poppies",
      "Daisies",
      "Tulips",
    ...
    "answer": "Poppies",
    "evidence": "Poppies put Dorothy and her friends to sleep."
  },
  {
    "id": 11,
    "question": "Auntie Em! Auntie Em! ______ my pretty! Finish this quote, spoken by The Wicked Witch of the West.",
    "options": [
      "I'll give you Auntie Em",
      "You're not in Kansas anymore",
      "You'll never see your Auntie Em again",
  ...
  {
    "id": 14,
    "question": "In Munchkinland, which hand does the Wicked Witch of the West hold her broomstick in?",
    "options": [
      "right",
      "both-she switches hands",
      "left",
      "she isn't carrying it then"
    ],
    "answer": "right",
    "evidence": "In Munchkinland, the Wicked Witch of the West holds her broomstick in her right hand."
  },
  {
    "id": 15,
    "question": "Put 'em up! Put 'em up! Which one of you first? I'll fight you both together if you want! I'll fight you ______! Finish this quote, spoken by the Cowardly Lion.",
    "options": [
      "with one paw tied behind my back",
      "with both paws tied behind my back",
      "with two paws in the air",
      "with lions and tigers and bears"
    ],
    "answer": "with one paw tied behind my back",
    "evidence": "The Cowardly Lion's quote finishes with 'with one paw tied behind my back'."
  }
];
...
export const LITTLE_RED_RIDING_HOOD_TRIVIA: MCTriviaQuestion[] = [
  ...
  },
  {
    ...
    "options": [
      ...
      "She shoots the wolf",
      "The wolf eats her and she is not rescued",
...
export const SNOW_WHITE_TRIVIA: MCTriviaQuestion[] = [
  ...
  {
    "id": 13,
    "question": "What did the dwarfs dig for in their mine during the day?",
    "options": [
      "Diamonds & rubies",
      "Gold & silver",
      "Coal & iron",
  ...
  {
    "id": 14,
    "question": "Which dwarf is the only one who does not have a beard?",
    "options": [
      "Dopey",
      "Sneezy",
      "Bashful",
...
export const ROBIN_HOOD_TRIVIA: MCTriviaQuestion[] = [
  ...
  {
    "id": 6,
    "question": "What color clothing do Robin and his men traditionally wear?",
    "options": [
      "Browns",
      "Lime Green",
      "Lincoln Green",
  ...
  {
    "id": 11,
    "question": "What weapon is Robin Hood most exceptionally skilled with?",
    "options": [
      "Sword",
      "Bow",
      "Pole-arm",
...
export const ALICE_IN_WONDERLAND_TRIVIA: MCTriviaQuestion[] = [
  ...
  },
  {
    ...
    "options": [
      ...
      "The Queen of Hearts banished them to a tea table",
  ...
  {
    "id": 14,
    "question": "What did Alice provide as prizes for the Caucus Race?",
    "options": [
      "Comfits",
      "Thimbles",
      "Flowers",
