...
import { WILD_ROBOT_1_TRIVIA, WILD_ROBOT_2_TRIVIA, WILD_ROBOT_3_TRIVIA, WILD_ROBOT_RANDOM_TRIVIA, WILD_ROBOT_GRADES } from './wildRobotTrivia';
...
import {
  ...
  LITTLE_RED_RIDING_HOOD_TRIVIA,
  SNOW_WHITE_TRIVIA,
  CINDERELLA_TRIVIA,
  ROBIN_HOOD_TRIVIA,
  ALICE_IN_WONDERLAND_TRIVIA,
  CLASSIC_TALES_GRADES
} from './classicTalesTrivia';
...
const getQuizTitle = (quizId: string): string => {
  ...
  const map: Record<string, string> = {
    ...
    'classic-tales-random': 'Classic Tales Mixed Challenge',
...
const SearchModal = ({ onClose }: { onClose?: () => void }) => {
  ...
  const results = useMemo(() => {
    ...
    const universeRouteMap: Record<string, string> = {
      ...
      'classic-tales': '/selector-classic-tales',
      'wizard-of-oz': '/trivia-wizard-of-oz',
      'ugly-duckling': '/trivia-ugly-duckling',
      'little-red-riding-hood': '/trivia-little-red-riding-hood',
      'snow-white': '/trivia-snow-white',
      'cinderella': '/trivia-cinderella',
      'robin-hood': '/trivia-robin-hood',
      'alice-in-wonderland': '/trivia-alice-in-wonderland',
      'goat': '/selector-goat',
...
const Footer = ({ isDashboard, onShowInfo }: { 
  ...
  <footer className={`border-t border-white/10 py-20 px-6 ${isDashboard ? 'bg-card-dark' : ''}`}>
    ...
    <div className={`max-w-${isDashboard ? '[1600px]' : '7xl'} mx-auto mt-20 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-slate-500 text-xs font-bold uppercase tracking-widest`}>
      <p>Â© 2026 {isDashboard ? 'PROHUB ESPORTS INC. ALL RIGHTS RESERVED.' : 'FANDOM TRIVIA INC. ALL RIGHTS RESERVED.'}</p>
      <p>CRAFTED WITH <span className="text-primary">â™¥</span> FOR FANS EVERYWHERE.</p>
    </div>
  </footer>
  );
};
    ...
    <div className="max-w-3xl mx-auto space-y-10">
      <div className="text-center space-y-3">
        ...
        <Helmet>
          ...
          <link rel="canonical" href="https://www.fandom-trivia.com/selector-twilight" />
          ...
          <script type="application/ld+json">
            {getBreadcrumbSchema([
              ...
              { name: "Twilight Saga", item: "https://www.fandom-trivia.com/selector-twilight" }
            ])}
          </script>
        </Helmet>
    ...
    <div className="max-w-3xl mx-auto space-y-10">
      <div className="text-center space-y-3">
        ...
        <Helmet>
          ...
          <link rel="canonical" href="https://www.fandom-trivia.com/selector-harry-potter" />
          ...
          <script type="application/ld+json">
            {getBreadcrumbSchema([
              { name: "Home", item: "https://www.fandom-trivia.com/" },
              { name: "Wizarding World", item: "https://www.fandom-trivia.com/selector-harry-potter" }
            ])}
          </script>
        </Helmet>
      ...
      <div className="max-w-3xl mx-auto space-y-10">
        <div className="text-center space-y-3">
          ...
          <Helmet>
            ...
            <link rel="canonical" href="https://www.fandom-trivia.com/selector-star-wars" />
            ...
            <script type="application/ld+json">
              {getBreadcrumbSchema([
                { name: "Home", item: "https://www.fandom-trivia.com/" },
                { name: "Star Wars", item: "https://www.fandom-trivia.com/selector-star-wars" }
              ])}
            </script>
          </Helmet>
    ...
    <div className="max-w-3xl mx-auto space-y-10">
      <div className="text-center space-y-3">
        ...
        <Helmet>
          ...
          <link rel="canonical" href="https://www.fandom-trivia.com/selector-hoppers" />
          ...
          <script type="application/ld+json">
            {getBreadcrumbSchema([
              { name: "Home", item: "https://www.fandom-trivia.com/" },
              { name: "Hoppers", item: "https://www.fandom-trivia.com/selector-hoppers" }
            ])}
          </script>
        </Helmet>
      ...
      <div className="text-center space-y-3">
        ...
        <Helmet>
          ...
          <script type="application/ld+json">
            {getBreadcrumbSchema([
              { name: "Home", item: "https://www.fandom-trivia.com/" },
              { name: "K-Pop: Demon Hunters", item: "https://www.fandom-trivia.com/selector-kpop" }
            ])}
          </script>
        </Helmet>
    ...
    <div className="max-w-3xl mx-auto space-y-10">
      <div className="text-center space-y-3">
        ...
        <Helmet>
          ...
          <link rel="canonical" href="https://www.fandom-trivia.com/selector-wicked" />
          ...
          <script type="application/ld+json">
            {getBreadcrumbSchema([
              { name: "Home", item: "https://www.fandom-trivia.com/" },
              { name: "Wicked", item: "https://www.fandom-trivia.com/selector-wicked" }
            ])}
          </script>
        </Helmet>
    ...
    <div className="max-w-3xl mx-auto space-y-10">
      <div className="text-center space-y-3">
        ...
        <Helmet>
          ...
          <link rel="canonical" href="https://www.fandom-trivia.com/selector-paw-patrol" />
          ...
          <script type="application/ld+json">
            {getBreadcrumbSchema([
              { name: "Home", item: "https://www.fandom-trivia.com/" },
              { name: "PAW Patrol", item: "https://www.fandom-trivia.com/selector-paw-patrol" }
            ])}
          </script>
        </Helmet>
    ...
    <div className="max-w-3xl mx-auto space-y-10">
      <div className="text-center space-y-3">
        ...
        <Helmet>
          ...
          <link rel="canonical" href="https://www.fandom-trivia.com/selector-three-body" />
          ...
          <script type="application/ld+json">
            {getBreadcrumbSchema([
              { name: "Home", item: "https://www.fandom-trivia.com/" },
              { name: "Three-Body Universe", item: "https://www.fandom-trivia.com/selector-three-body" }
            ])}
          </script>
        </Helmet>
        <p className="text-slate-400 font-medium">Select a book to test your knowledge, or try a random mix from all!</p>
    ...
    <div className="max-w-3xl mx-auto space-y-10">
      <div className="text-center space-y-3">
        ...
        <Helmet>
          ...
          <link rel="canonical" href="https://www.fandom-trivia.com/selector-zootopia" />
          ...
          <script type="application/ld+json">
            {getBreadcrumbSchema([
              { name: "Home", item: "https://www.fandom-trivia.com/" },
              { name: "Zootopia Universe", item: "https://www.fandom-trivia.com/selector-zootopia" }
            ])}
          </script>
        </Helmet>
...
const MCQuizContent = ({ questions = [], title, scoreLabel, grades, user, onQuizComplete, isDaily }: {
  ...
  const handleSelect = (option: string) => {
    ...
    if (isUnknown) {
      // No known answer â€” auto-mark correct (fun mode)
  ...
  const teamAPictures = isTeamA
    ...
    : (gameMode === 'bot' ? ['https://www.fandom-trivia.com/bot.png'] : opponents.map(o => o.picture).filter(Boolean) as string[]);
                ...
                <div className="relative group hover:scale-105 transition-transform">
                  ...
                  <div className="relative p-6 bg-white/5 rounded-full border-2 border-purple-500/30 shadow-2xl backdrop-blur-md">
                    <SimpleAvatar 
                      ...
                      picture={gameMode === 'bot' ? 'https://www.fandom-trivia.com/bot.png' : (opponents[0]?.picture || getQuizImage(scoreLabel))} 
                      size={120} 
                    />
                    <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 px-4 py-1 rounded-full bg-purple-500 text-white text-[10px] font-black uppercase tracking-widest shadow-xl whitespace-nowrap">
...
const FROZEN_GRADES = [
  { threshold: 90, label: 'Snow Queen', color: 'text-sky-300', character: { name: 'Elsa', image: '/images/frozen.jpg', desc: 'The cold never bothered you anyway! You are a master of Arendelleâ€™s history.' } },
    ...
    <div className="max-w-3xl mx-auto space-y-10">
      <div className="text-center space-y-3">
        ...
        <Helmet>
          ...
          <link rel="canonical" href="https://www.fandom-trivia.com/selector-frozen" />
          ...
          <script type="application/ld+json">
            {getBreadcrumbSchema([
              { name: "Home", item: "https://www.fandom-trivia.com/" },
              { name: "Frozen Universe", item: "https://www.fandom-trivia.com/selector-frozen" }
            ])}
          </script>
        </Helmet>
...
// --- The Wild Robot Selector ---

const WildRobotSelector = () => {
  const navigate = useNavigate();
  const { getQuizCount, formatCount } = useQuizStats();
  return (
  <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="pt-28 pb-20 px-6">
    <div className="max-w-3xl mx-auto space-y-10">
      <div className="text-center space-y-3">
        ...
        <h1 className="text-4xl md:text-5xl font-black text-white tracking-tighter">Choose Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-300 to-teal-200">Survival Challenge</span></h1>
        <Helmet>
          <title>The Wild Robot Trivia & Quizzes | Fandom Trivia</title>
          <meta name="description" content="Test your knowledge on The Wild Robot trilogy. From Roz ROZZUM 7134 and Brightbill to Fink, Hilltop Farm, and the poison tide, prove your wilderness skills." />
          <link rel="canonical" href="https://www.fandom-trivia.com/selector-wild-robot" />
          <meta property="og:title" content="The Wild Robot Trivia & Quizzes | Fandom Trivia" />
          <meta property="og:description" content="Enter the wilderness with Roz and Brightbill in the ultimate Wild Robot trivia challenge." />
          <script type="application/ld+json">
            {getBreadcrumbSchema([
              { name: "Home", item: "https://www.fandom-trivia.com/" },
              { name: "The Wild Robot Universe", item: "https://www.fandom-trivia.com/selector-wild-robot" }
            ])}
          </script>
        </Helmet>
        <p className="text-slate-400 font-medium">Select a book or film challenge to test your survival skills, or try a random mix of all three!</p>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        {[
          { label: 'Book 1', title: 'The Wild Robot (Original)', desc: `${WILD_ROBOT_1_TRIVIA.length} questions on the island survival`, icon: "🤖", view: 'trivia-wild-robot-1', gradient: 'from-emerald-600/20 to-teal-600/20', border: 'border-emerald-500/30 hover:border-emerald-400/50' },
          { label: 'Book 2', title: 'The Wild Robot Escapes', desc: `${WILD_ROBOT_2_TRIVIA.length} questions on Hilltop Farm`, icon: "🚜", view: 'trivia-wild-robot-2', gradient: 'from-amber-600/20 to-orange-600/20', border: 'border-amber-500/30 hover:border-amber-400/50' },
          { label: 'Book 3', title: 'The Wild Robot Protects', desc: `${WILD_ROBOT_3_TRIVIA.length} questions on the poison tide`, icon: "🌊", view: 'trivia-wild-robot-3', gradient: 'from-cyan-600/20 to-blue-600/20', border: 'border-cyan-500/30 hover:border-cyan-400/50' },
          { label: 'Random', title: 'Mixed Challenge', desc: '15 random questions from all three books', icon: "🎲", view: 'trivia-wild-robot-random', gradient: 'from-fuchsia-600/20 to-pink-600/20', border: 'border-fuchsia-500/30 hover:border-fuchsia-400/50' },
        ].map(film => (
          <motion.button
            key={film.title}
            whileHover={{ scale: 1.03, y: -4 }}
          ...
          >
            <div className="space-y-4">
              ...
              <div>
                <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1">{film.label}</p>
                <h3 className="text-lg font-black text-white tracking-tight leading-snug">{film.title}</h3>
                <p className="text-xs text-slate-400 font-medium mt-1 leading-relaxed">{film.desc}</p>
              </div>
            </div>
    ...
    <div className="max-w-3xl mx-auto space-y-10">
      <div className="text-center space-y-3">
        ...
        <Helmet>
          ...
          <link rel="canonical" href="https://www.fandom-trivia.com/selector-moana" />
          ...
          <script type="application/ld+json">
            {getBreadcrumbSchema([
              { name: "Home", item: "https://www.fandom-trivia.com/" },
              { name: "Moana Universe", item: "https://www.fandom-trivia.com/selector-moana" }
            ])}
          </script>
        </Helmet>
    ...
    <div className="max-w-3xl mx-auto space-y-10">
      <div className="text-center space-y-3">
        ...
        <Helmet>
          ...
          <link rel="canonical" href="https://www.fandom-trivia.com/selector-goat" />
          ...
          <script type="application/ld+json">
            {getBreadcrumbSchema([
              { name: "Home", item: "https://www.fandom-trivia.com/" },
              { name: "GOAT", item: "https://www.fandom-trivia.com/selector-goat" }
            ])}
          </script>
        </Helmet>
    ...
    <div className="max-w-3xl mx-auto space-y-10">
      <div className="text-center space-y-3">
        ...
        <Helmet>
          ...
          <link rel="canonical" href="https://www.fandom-trivia.com/selector-cat-in-the-hat" />
          ...
          <script type="application/ld+json">
            {getBreadcrumbSchema([
              { name: "Home", item: "https://www.fandom-trivia.com/" },
              { name: "Cat in the Hat", item: "https://www.fandom-trivia.com/selector-cat-in-the-hat" }
            ])}
          </script>
        </Helmet>
      ...
      <div className="max-w-3xl mx-auto space-y-10">
        <div className="text-center space-y-3">
          ...
          <Helmet>
            ...
            <link rel="canonical" href="https://www.fandom-trivia.com/selector-how-to-train-your-dragon" />
            ...
            <script type="application/ld+json">
              {getBreadcrumbSchema([
                { name: "Home", item: "https://www.fandom-trivia.com/" },
                { name: "How to Train Your Dragon", item: "https://www.fandom-trivia.com/selector-how-to-train-your-dragon" }
              ])}
            </script>
          </Helmet>
      ...
      <div className="max-w-3xl mx-auto space-y-10">
        <div className="text-center space-y-3">
          ...
          <Helmet>
            ...
            <link rel="canonical" href="https://www.fandom-trivia.com/selector-avatar" />
            ...
            <script type="application/ld+json">
              {getBreadcrumbSchema([
                { name: "Home", item: "https://www.fandom-trivia.com/" },
                { name: "Avatar Universe", item: "https://www.fandom-trivia.com/selector-avatar" }
              ])}
            </script>
          </Helmet>
    ...
    <div className="max-w-3xl mx-auto space-y-10">
      <div className="text-center space-y-3">
        ...
        <Helmet>
          ...
          <link rel="canonical" href="https://www.fandom-trivia.com/selector-minecraft" />
          ...
          <script type="application/ld+json">
            {getBreadcrumbSchema([
              { name: "Home", item: "https://www.fandom-trivia.com/" },
              { name: "Minecraft Universe", item: "https://www.fandom-trivia.com/selector-minecraft" }
            ])}
          </script>
        </Helmet>
    ...
    <div className="max-w-3xl mx-auto space-y-10">
      <div className="text-center space-y-3">
        ...
        <Helmet>
          ...
          <link rel="canonical" href="https://www.fandom-trivia.com/selector-super-mario" />
          ...
          <script type="application/ld+json">
            {getBreadcrumbSchema([
              { name: "Home", item: "https://www.fandom-trivia.com/" },
              { name: "Super Mario Galaxy Universe", item: "https://www.fandom-trivia.com/selector-super-mario" }
            ])}
          </script>
        </Helmet>
    ...
    <div className="max-w-3xl mx-auto space-y-10">
      <div className="text-center space-y-3">
        ...
        <Helmet>
          ...
          <link rel="canonical" href="https://www.fandom-trivia.com/selector-despicable-me" />
          ...
          <script type="application/ld+json">
            {getBreadcrumbSchema([
              { name: "Home", item: "https://www.fandom-trivia.com/" },
              { name: "Despicable Me Universe", item: "https://www.fandom-trivia.com/selector-despicable-me" }
            ])}
          </script>
        </Helmet>
          ...
          {UNIVERSES.filter(universe => !universe.hideOnHomepage).map((universe, i) => (
            <motion.div
              ...
              onClick={() => {
                ...
                if (universe.id === 'wild-robot') navigate('/selector-wild-robot');
        ...
        <div className="text-center space-y-3">
          ...
          <Helmet>
            ...
            <script type="application/ld+json">
              {getBreadcrumbSchema([
                { name: "Home", item: "https://www.fandom-trivia.com/" },
                { name: "Toy Story", item: "https://www.fandom-trivia.com/selector-toy-story" }
              ])}
            </script>
          </Helmet>
      ...
      <div className="max-w-3xl mx-auto space-y-10">
        <div className="text-center space-y-3">
          ...
          <Helmet>
            ...
            <link rel="canonical" href="https://www.fandom-trivia.com/selector-shrek" />
            ...
            <script type="application/ld+json">
              {getBreadcrumbSchema([
                { name: "Home", item: "https://www.fandom-trivia.com/" },
                { name: "Shrek", item: "https://www.fandom-trivia.com/selector-shrek" }
              ])}
            </script>
          </Helmet>
      ...
      <div className="max-w-3xl mx-auto space-y-10">
        <div className="text-center space-y-3">
          ...
          <Helmet>
            ...
            <link rel="canonical" href="https://www.fandom-trivia.com/selector-bad-guys" />
            ...
            <script type="application/ld+json">
              {getBreadcrumbSchema([
                { name: "Home", item: "https://www.fandom-trivia.com/" },
                { name: "The Bad Guys", item: "https://www.fandom-trivia.com/selector-bad-guys" }
              ])}
            </script>
          </Helmet>
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        <div className="text-center space-y-3">
          ...
          <Helmet>
            ...
            <link rel="canonical" href="https://www.fandom-trivia.com/selector-dog-man" />
            ...
            <script type="application/ld+json">
              {getBreadcrumbSchema([
                { name: "Home", item: "https://www.fandom-trivia.com/" },
                { name: "Dog Man", item: "https://www.fandom-trivia.com/selector-dog-man" }
              ])}
            </script>
          </Helmet>
        ...
        <div className="text-center space-y-3">
          ...
          <Helmet>
            ...
            <script type="application/ld+json">
              {getBreadcrumbSchema([
                { name: "Home", item: "https://www.fandom-trivia.com/" },
                { name: "Classic Tales", item: "https://www.fandom-trivia.com/selector-classic-tales" }
              ])}
            </script>
          </Helmet>
          <p className="text-slate-400 font-medium">Select a classic story to test your knowledge, or try a random mix from the full collection.</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
          {[
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.03, y: -4 }}
              whileTap={{ scale: 0.98 }}
              onClick={() => navigate(`/${story.view}`)}
              className={`text-left p-6 rounded-2xl bg-gradient-to-br ${story.gradient} border ${story.border} transition-all duration-300 space-y-4 group`}
            >
              <div className="text-4xl">{story.icon}</div>
              <div>
                <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1">{story.label}</p>
                <h3 className="text-xl font-black text-white tracking-tight">{story.title}</h3>
                <p className="text-sm text-slate-400 font-medium mt-1">{story.desc}</p>
              </div>
              <div className="flex items-center gap-2 text-xs font-bold text-primary opacity-0 group-hover:opacity-100 transition-opacity">
                Start Quiz <ArrowRight className="size-3" />
              </div>
      ...
      <div className="max-w-3xl mx-auto space-y-10">
        <div className="text-center space-y-3">
          ...
          <Helmet>
            ...
            <link rel="canonical" href="https://www.fandom-trivia.com/selector-kung-fu-panda" />
            ...
            <script type="application/ld+json">
              {getBreadcrumbSchema([
                { name: "Home", item: "https://www.fandom-trivia.com/" },
                { name: "Kung Fu Panda", item: "https://www.fandom-trivia.com/selector-kung-fu-panda" }
              ])}
            </script>
          </Helmet>
          <p className="text-slate-400 font-medium">Select a film to test your knowledge, or try a random mix from the full saga.</p>
    ...
    BADGES.forEach(badge => {
      ...
      if (badge.targetQuiz) {
        ...
        if (titleLower.includes(badge.targetQuiz.replace('-', ' '))) {
          ...
          unlocked = true;
        } else if (badge.targetQuiz === 'classic-tales' && (
      ...
      <main>
        <AnimatePresence mode="wait">
          <Routes location={location}>
            ...
            <Route path="/selector-wild-robot" element={<WildRobotSelector />} />
            <Route path="/trivia-wild-robot-1" element={<MCQuizView key="trivia-wild-robot-1" questions={WILD_ROBOT_1_TRIVIA} title="The Wild Robot (Book 1)" scoreLabel="The Wild Robot" grades={WILD_ROBOT_GRADES} user={user} isDaily={location.state?.isDaily} onQuizComplete={evaluateBadges} />} />
            <Route path="/trivia-wild-robot-2" element={<MCQuizView key="trivia-wild-robot-2" questions={WILD_ROBOT_2_TRIVIA} title="The Wild Robot Escapes" scoreLabel="The Wild Robot Escapes" grades={WILD_ROBOT_GRADES} user={user} isDaily={location.state?.isDaily} onQuizComplete={evaluateBadges} />} />
            <Route path="/trivia-wild-robot-3" element={<MCQuizView key="trivia-wild-robot-3" questions={WILD_ROBOT_3_TRIVIA} title="The Wild Robot Protects" scoreLabel="The Wild Robot Protects" grades={WILD_ROBOT_GRADES} user={user} isDaily={location.state?.isDaily} onQuizComplete={evaluateBadges} />} />
            <Route path="/trivia-wild-robot-random" element={<MCQuizView key="trivia-wild-robot-random" questions={WILD_ROBOT_RANDOM_TRIVIA} title="The Wild Robot Mixed Challenge" scoreLabel="The Wild Robot Mixed Challenge" grades={WILD_ROBOT_GRADES} user={user} isDaily={location.state?.isDaily} onQuizComplete={evaluateBadges} />} />
            ...
            {/* Classic Tales Trivia */}
            <Route path="/selector-classic-tales" element={<ClassicTalesSelector />} />
